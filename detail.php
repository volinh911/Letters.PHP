...
<body class="detail-wrapper">
    ...
    <section class="detail-header"> <?php include_once('./includes/sub_header.php'); ?>
    </section>

    <div class="container page-wrapper">
        <!--Navigation-->
        <div class="div m-3 redirect">
            <a href="posts.php">
                << Back to Posts</a>
                    <hr>
        </div>
        ...
        <div class="topic-container p-5">
            ...
            <div class="body">
                <div class="authors">
                    ...
                    <!-- Role admin/user -->
                    <div>Role: <?php if ($post["admin"] == 0) : echo "Normal User";
                                else : echo "Admin";
                                endif; ?></div>
                    <!-- Khong profile image thi hinh mac dinh -->
                    <img src="<?php if ($post['image_profile'] != null) : echo $post['image_profile'];
                                else : echo "https://cdn.pixabay.com/photo/2015/11/06/13/27/ninja-1027877_960_720.jpg";
                                endif; ?>" alt="" id="avatar">
                    <!-- Dem post Author -->
        ...
        <?php else : ?>
            <div class="row justify-content-center">
                <div class="my-5 p-4 col-md-6 text-center login-request">
            ...
            <div class="container comments my-5 p-3">
                <div class="body">
                    <div class="authors">
                        ...
                        <!-- Role admin/user -->
                        <div>Role <?php if ($userComment['admin'] == 0) : echo "Normal User";
                                    else : echo "Admin";
                                    endif; ?>
                        </div>
                        <!-- Khong hinh = hinh mac dinh -->
                        <img src="<?php if ($userComment['image_profile'] != null) : echo $userComment['image_profile'];
                                    else : echo "https://cdn.pixabay.com/photo/2015/11/06/13/27/ninja-1027877_960_720.jpg";
                                    endif; ?>" alt="" id="avatar">
                        ...
                        <!-- Lay value tu key -->
                        <div>Number of Posts:
                            <?php if ($posts->countPost($userComment['user_id']) < 1) : echo "0";
                            else : echo implode($posts->countPost($userComment['user_id']));
                            endif; ?>
                            <u></u>
                        </div>
                    </div>
                    <div class="content">
                        ...
                        <?php if (isset($_SESSION["user_id"])) : ?>
                            <?php if ($user_id == $userComment['user_id'] || $_SESSION["admin"] == 1) : ?>
                                ...
                                <form action="detail.php?id=<?php echo $post_id; ?>" method="POST">
                                    <button type="submit" value="<?php echo $userComment["comment_id"]; ?>" name="delete-comment">Delete </button>

                                    <button type="submit" value="<?php echo $userComment["comment_id"]; ?>" name="edit-comment">Edit </button>
                                </form>
